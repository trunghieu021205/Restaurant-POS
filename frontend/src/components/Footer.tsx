      ...
      <div className="container mx-auto px-4 py-section-mobile md:py-section">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <Link
              href="/"
              className="inline-flex items-center space-x-2 text-2xl font-bold text-white mb-3"
            >
              <span className="text-3xl">🍕</span>
              <span>Restaurant</span>
            </Link>
            <p className="text-sm text-neutral-400 leading-relaxed">
              Hệ thống đặt món ăn trực tuyến, phục vụ tận bàn với trải nghiệm
        ...
        <div className="border-t border-neutral-800 mt-12 pt-8 text-center text-sm text-neutral-500">
          <p>
            © {new Date().getFullYear()} Restaurant. Tất cả quyền được bảo lưu.
          </p>
        </div>
      </div>
    </footer>
